...
It was fun to come up with a *theme* for the solitaire game (as I would come up with different themes for other solitaire variations). Once I had decided on a young woman’s parlour around 100 years ago, trips to antique stores would see me return with a small teacup, costume jewelry, etc.

A piece of cherry plywood I finished, covered over with a vintage tablecloth and various bits of antique store paraphernalia arranged around... I suspended a digital SLR above and photographed the backdrop for the game.

A blank piece of paper stock in the lower left served as the background for (limited) user controls.
...
The card engine I used in both this solitaire game and others I based around the idea of “stacks” of cards.
